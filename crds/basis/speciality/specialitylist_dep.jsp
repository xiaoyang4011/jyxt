...
<div align="center">
			<iframe name="listPage" src="<%=path%>/speciality_query_dep.do?dep_code=<%=request.getParameter("dep_code")%>" frameborder="0" scrolling="no" width="100%"
...
<script>
 ...
 {
   location.href("speciality_add_dep.do");   
 }	
</script>