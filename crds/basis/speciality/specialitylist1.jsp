...
<body>
<div class="body-box">
<html:form styleId="queryroleform" action="speciality_query.do?listpage=1" method="post" style="padding-top:5px;"> 
...
<tbody  class="pn-ltbody">
   ...
   <c:forEach items="${specialitylist}" var="s" varStatus="cnt">	 
	   ...
	   <td align="center"><html:link page="/updateSpeciality.do?spec_code=${s.spec_code}&dep_code=${s.dep_code}" target="mainFrame">修改</html:link>
