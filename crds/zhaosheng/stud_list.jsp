...
状态：<select name="user_state" id="user_state"><option value="${user_state}">-请选择-</option><option value="2">就业</option><option value="0">未就业</option></select>
...
<thead class="pn-lthead"><tr>
	...
	<logic:iterate name="list" id="map">
		...
		<td align="center">${map.cy_name}</td> 
	   	...
	   	<td align="center"> <html:link page="/bro_cy_zs.do?user_ID=${map.user_ID}">选择就业</html:link>
	   	 | <html:link page="/del_company.do?user_ID=${map.user_ID}" onclick="return window.confirm('确定执行该操作？')">取消就业</html:link> 
	    </tr>
	 	</logic:iterate>
	</logic:present>
</tbody>
