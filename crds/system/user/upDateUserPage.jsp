...
<div class="box-positon">
	<div class="rpos">当前位置: 用戶管理 - 修改</div>
	<form class="ropt">
...
<div class="body-box">
<form action="<%=path%>/updatePackage.do" method="post" onSubmit="return yanzheng()">
<table align="center" width="80%" class="pn-ftable" cellpadding="2" cellspacing="1" border="0">
<tr>



   <td width="30%" class="pn-flabel pn-flabel-h"><span class="pn-frequired">*</span>系部-专业-班级:
   

   </td>
    <td colspan="1" width="70%" class="pn-fcontent">
	<select name="dept" id="dept" onchange="getSpecList1();getClassList1();">
	<option value="0">-请选择-</option>	
	</select>
     <select name="spec" id="spec" onchange="getClassList1()"><option value="0">-请选择-</option></select>
...
<logic:present name="userinfo">
	<logic:iterate name="userinfo" id="us">
	
	
<tr>
   <td width="30%" class="pn-flabel pn-flabel-h"><span class="pn-frequired">*</span>用户ID：</td>
    <td colspan="1" width="70%" class="pn-fcontent">
	<input type="text" maxlength="100" name="user_ID" id="user_ID" value="${us.user_ID}" readonly=true onblur="temp()" maxlength="100"/> <span class="pn-fhelp">由不超过4位的数字组成，如01</span>
    </td>
</tr>
<tr>
   <td width="30%" class="pn-flabel pn-flabel-h"><span class="pn-frequired">*</span>密码：</td>
    <td colspan="1" width="70%" class="pn-fcontent">
	<input type="password" maxlength="100" name="password" id="password" value="${us.password}" maxlength="100"/> <span class="pn-fhelp">请输入字母或字母数字组合</span>
    </td>
</tr>
<tr>
...
<tr>
   <td width="30%" class="pn-flabel pn-flabel-h"><span class="pn-frequired">*</span>真实姓名：</td>
    <td colspan="1" width="70%" class="pn-fcontent">
	<input type="text" maxlength="100" name="real_name" id="real_name" value="${us.real_name}" maxlength="100"/> <span class="pn-fhelp">不能超过4位字符</span>
    </td>
</tr>
...
<tr>
   <td width="30%" class="pn-flabel pn-flabel-h"><span class="pn-frequired">*</span>用户类型：</td>
    <td colspan="1" width="70%" class="pn-fcontent">
	<input type="radio" name="user_type" id="user_type" value="教师" ${usertytea}>教师
          <input type="radio" name="user_type" id="user_type" value="学生"  ${usertystu}> 学生
	 <span class="pn-fhelp">&nbsp&nbsp&nbsp&nbsp&nbsp请点击 所选的类型</span>
    </td>
</tr>

<tr>
   <td width="30%" class="pn-flabel pn-flabel-h"><span class="pn-frequired">*</span>用户积分：</td>
    <td colspan="1" width="70%" class="pn-fcontent">
	<input type="text" maxlength="100" name="user_point" id="user_point" value="${us.user_point}" onblur="userJIFen()" maxlength="100"/> <span class="pn-fhelp">由不超过2位的【数字】组成，如31</span>
    </td>
</tr>
<tr> <td width="30%" class="pn-flabel pn-flabel-h"><span class="pn-frequired">*</span>角色：</td>
  <td colspan="1" width="70%" class="pn-fcontent">
   <logic:present name="roleinfo">
	<logic:iterate name="roleinfo" id="map">
      <input type="checkbox" name="roleList" id="roleList" ${map.check} value="${map.role_id}"/> ${map.role_name} 
        </logic:iterate>
	</logic:present>
...
<tr>
   <td width="30%" class="pn-flabel pn-flabel-h"><span class="pn-frequired">*</span>会员类型：</td>
    <td colspan="1" width="70%" class="pn-fcontent">
	<input type="radio" name="member_type" id="member_type" value="2" ${putong}>普通会员
	<input type="radio" name="member_type" id="member_type" value="3" ${gaoji}>高级会员
	<input type="radio" name="member_type" id="member_type" value="4" ${vip}>VIP会员
     </td>
</tr>
