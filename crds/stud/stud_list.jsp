...
<div class="box-positon">
	<div class="rpos">当前位置:学生信息 - 列表</div>
...
<thead class="pn-lthead"><tr>
	...
	<logic:iterate name="list" id="map">
		...
		<td align="center">${map.cy_name}</td> 
	   	...
	   	<td align="center"> <html:link page="/bro_cy_zs.do?user_ID=${map.user_ID}">修改</html:link>
	   	 | <html:link page="/del_company.do?user_ID=${map.user_ID}" onclick="return window.confirm('确定执行该操作？')">删除</html:link> 
	    </tr>
	 	</logic:iterate>
	</logic:present>
</tbody>
