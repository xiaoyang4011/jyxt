...
<thead class="pn-lthead">
	<tr>
	    ...
	    <td bgcolor="#FFFFFF">&nbsp;<input name="new_title" type="text" value="${map.new_title}"/></td>
	</tr>
	<tr>
	    <td class="pn-flabel pn-flabel-h" width="40%"><div align="right"><span class="pn-frequired">*</span>新闻作者：</div></td>
	    <td bgcolor="#FFFFFF">&nbsp;<input name="new_author" type="text" value="${map.new_author}"/></td>
	</tr>
	...
	<tr> 
	        ...
	        <textarea name="news" id="description" style="width: 100%;height: 300px;">${map.news}</textarea>
